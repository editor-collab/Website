...
/* ── Cursor SVG — uses /assets/Mouse.svg path, colored per cursor ── */
...
/* ── Colors that need dark text to stay readable ─────────────────── */
const LIGHT_COLORS = new Set(["#FFDFA4", "#FEA3B3", "#FFFFFF"]);

/* ── Cursor config — edit names & positions freely ──────────────── */
const CURSORS = [
  { id: 1, color: "#FE3794", name: "ninxout",   top: "11%", left: "6%",  delay: "0.05s", anim: "cursor-from-topleft"  },
  { id: 2, color: "#5FD5EC", name: "hjfod",     top: "63%", left: "82%", delay: "0.25s", anim: "cursor-from-botright" },
  { id: 3, color: "#FFDFA4", name: "imfiree", top: "15%", left: "76%", delay: "0.45s", anim: "cursor-from-topright" },
  { id: 4, color: "#367AD4", name: "fleeym",    top: "52%", left: "3%",  delay: "0.15s", anim: "cursor-from-left"     },
  { id: 5, color: "#FEA3B3", name: "alk1m123",     top: "78%", left: "42%", delay: "0.55s", anim: "cursor-from-bottom"   },
  { id: 6, color: "#FFFFFF", name: "itsccrysx",   top: "32%", left: "90%", delay: "0.35s", anim: "cursor-from-right"    },
] as const;
