...
// ── Wave animation toggle — set to false to freeze the waves ──────────
...
const SLIDES = [
  {
    id: 1,
    label: "Live, Always.",
    description: "See every change your collaborators make.",
    accent: "#f765aa",
    src: "/assets/Placeholder.png",
  },
  {
    id: 2,
    label: "Stay within the limits.",
    description: "As a host, You can limit each collaborator's permissions.",
    accent: "#5FD5EC",
    src: "/assets/Placeholder.png",
  },
  {
    id: 3,
    label: "Keep your ideas, In one editor.",
    description: "Whether is a Megacollab, Collab or a casual project, Editor collab is for you.",
    accent: "#FFDFA4",
    src: "/assets/Placeholder.png",
  },
  {
    id: 4,
    label: "Made for simplicity, And efficiency.",
    description: "The creator of Editor Collab (alk1m123) is a Lead Developer of geode, Making Editor Collab very trusted across the community.",
    accent: "#FEA3B3",
    src: "/assets/Placeholder.png",
  },
];
...
export default function HeroSection() {
  ...
  // Manual navigation — also resets the countdown
  ...
  return (
    <div className="hero-bg min-h-screen bg-ink text-white pt-18 flex flex-col justify-center">
      {/* Wave layers — each SVG is 200 % wide (two tiled copies) so the
          wave-flow animation can loop seamlessly. Toggle ANIMATE_WAVES
          at the top of this file to freeze them. */}
      ...
      {/* Collab cursors — 6 colored mice with editable name tags */}
      <CollabCursors />
      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-6 py-16 lg:px-8 flex flex-col items-center">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16 w-full">
          ...
          {/* Left side — card with blur on mobile, plain on desktop */}
          ...
          <div className="flex flex-1 flex-col items-center gap-4 w-full max-w-xl">
            ...
            >
              ...
              {SLIDES.map((slide, i) => (
                ...
                >
                  {/* Image — swap the placeholder div for <Image> once you have assets */}
                  {slide.src ? (
                    <img
                      src={slide.src}
                      alt={slide.label}
                  ...
                  {/* Bottom gradient — makes text readable over any image */}
                  <div
                  ...
                  <div className="absolute top-3 left-3 z-20">
                    ...
                    <span
                      className="inline-flex items-center rounded-lg px-3 py-1.5 text-sm font-semibold backdrop-blur-xl"
                      style={{
                        background: `${darkenHex(slide.accent, 0.95)}70`,
                        border: `1px solid ${darkenHex(slide.accent, 0.2)}60`,
                        color: slide.accent,
                      }}
                    >
                      {slide.label}
                  ...
                  {/* Description — bottom-left, over the gradient */}
