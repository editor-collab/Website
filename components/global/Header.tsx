...
import NAV_DATA from "@/data/nav.json"
...
export function HeroHeader() {
  ...
  const mainItems = NAV_DATA.mainLinks.map((link) => (
  ...
  const otherItems = [
    ...
    <a
      key="discord"
      href={NAV_DATA.discordUrl}
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] transition-colors rounded-2xl px-4 py-2 text-white text-sm font-medium"
    >
